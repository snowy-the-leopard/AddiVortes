...
\begin{tabular}{ |c|c|c| }
\hline
\textbf{Choice/parameter} & \textbf{Notation} & \textbf{Default value/Prior distribution}\\
\hline\hline
Metric to use & $d$ & Euclidean\\
Number of tessellations & $m$ & 200 \\
\hline\hline
Variance of noise & $\sigma$ & $\propto \frac{ \nu \lambda }{ \chi^2 _\nu }$\footnotemark[1]\\[0.1cm]
\hline
Noise degrees of freedom hyperparameter & $\nu$ & $3-10(6)$\\
Noise alignment hyperparameter & $q$ & $0.7-0.99(0.85)$\\
\hline\hline
...
\hline
Number of covariates hyperparameter & $\omega$ & $\min(3, p)$ \\
Number of centers hyperparameter & $\lambda_c$ & \\
Center coordinates hyperparameter & $\sigma_c$ & \\
\hline
\hline
Mean response of cell $i$ under tessellation $j$ & $\mu_{ij}$ & $\mathcal{N}(\mu_\mu, \sigma_\mu^2)$\\
\hline
Mean response center hyperparameter & $\mu_\mu$ & 0\footnotemark[3]\\
Mean response spread hyperparameter & $\sigma_\mu$ & $\frac{0.5}{k\sqrt{m}}$\footnotemark[4]\\
Mean response alignment hyperparameter & $k$ & $3$\\
\hline\hline
Probability of adding/removing a center & --- & 0.2\\
Probability of adding/removing a covariate & --- & 0.2\\
Probability of swapping a covariate & --- & 0.1\\
Probability of changing the position of a center & --- & 0.1\\
\hline\hline
Number of MCMC iterations & --- & 1200\\
Number of MCMC burn-ins & --- & 200\\
\hline
\end{tabular}
\end{center}
