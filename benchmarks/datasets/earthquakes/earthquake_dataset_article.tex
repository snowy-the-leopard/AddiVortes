...
# After subsetting, 'magType', 'status', and 'net' are constant and carry no information.
...
Table 1 describes each of the 11 covariates retained in the
...
This dataset offers a
genuine mix of scales and types --- degrees, kilometers, seconds, magnitude
units, and station counts among the numeric covariates, with global latitude/longitude coverage and no missing
