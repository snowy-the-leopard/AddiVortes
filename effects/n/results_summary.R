...
yhat <- predict(model_iRMSE)
r2 <- 1 - sum((df_fit$median_in_sample_rmse - yhat)^2) /
  sum((df_fit$median_in_sample_rmse - mean(df_fit$median_in_sample_rmse))^2)
r2

yhat <- predict(model_oRMSE)
r2 <- 1 - sum((df_fit$median_out_sample_rmse - yhat)^2) /
  sum((df_fit$median_out_sample_rmse - mean(df_fit$median_out_sample_rmse))^2)
r2
